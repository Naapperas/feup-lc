...
\label{i8254_8h_source}\index{src/devices/timer/i8254.h@{src/devices/timer/i8254.h}}
...
\DoxyCodeLine{7 }
\DoxyCodeLine{14 \textcolor{preprocessor}{\#define TIMER\_FREQ 1193182 }}
...
\DoxyCodeLine{57 \textcolor{comment}{/* PARSE TIMER CONFIG */}}
\DoxyCodeLine{58 }
\DoxyCodeLine{59 \textcolor{preprocessor}{\#define TIMER\_ST\_INI\_RW (TIMER\_RB\_COUNT\_ | TIMER\_RB\_STATUS\_) }}
\DoxyCodeLine{60 \textcolor{preprocessor}{\#define TIMER\_ST\_MODE (BIT(3) | (BIT(2) | BIT(1)))           }}
\DoxyCodeLine{61 \textcolor{preprocessor}{\#define TIMER\_ST\_BCD (BIT(0))                                }}
\DoxyCodeLine{63 \textcolor{comment}{/* PARSE TIMER BYTES */}}
\DoxyCodeLine{64 }
\DoxyCodeLine{65 \textcolor{preprocessor}{\#define TIMER\_LSB\_MASK 0x00FF }}
\DoxyCodeLine{66 \textcolor{preprocessor}{\#define TIMER\_MSB\_MASK 0xFF00 }}
\DoxyCodeLine{68 \textcolor{comment}{/* MAX FREQUENCIES */}}
\DoxyCodeLine{69 \textcolor{preprocessor}{\#define TIMER\_MIN\_FREQ\_BCD 120 }}
\DoxyCodeLine{70 \textcolor{preprocessor}{\#define TIMER\_MIN\_FREQ\_BIN 19  }}
\DoxyCodeLine{74 \textcolor{preprocessor}{\#endif }\textcolor{comment}{/* \_LCOM\_I8254\_H */}\textcolor{preprocessor}{}}
